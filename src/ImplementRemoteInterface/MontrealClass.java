...
public class MontrealClass extends AddItemInterfacePOA{
	...
	private HashMap<String, List<BookedEvents>> BookedEvents = new HashMap<String, List<BookedEvents>>();
	private HashMap<String,LinkedList<String>> userinfor=new HashMap<String,LinkedList<String>>();
	private String cityName = "MTL";
	...
	public MontrealClass()throws Exception{
		...
		Conferences.put("MTLA100519", new Event("Conferences", "MTLA100519", 20 ));
		Conferences.put("MTLE100519", new Event("Conferences", "MTLE100519", 20 ));
		Conferences.put("MTLM100519", new Event("Conferences", "MTLM100519", 20 ));
	
		Seminars.put("MTLA100619", new Event("Seminars", "MTLA100619", 20 ));
		Seminars.put("MTLE100619", new Event("Seminars", "MTLE100619", 20 ));
		Seminars.put("MTLM100719", new Event("Seminars", "MTLM100619", 20 ));
			
		TradeShows.put("MTLA100719", new Event("TradeShows", "MTLA100719", 20 ));
		TradeShows.put("MTLE100719", new Event("TradeShows", "MTLE100719", 20 ));
		TradeShows.put("MTLM100719", new Event("TradeShows", "MTLM100719", 20 ));
