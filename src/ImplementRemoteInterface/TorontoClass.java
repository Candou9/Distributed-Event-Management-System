...
public class TorontoClass extends AddItemInterfacePOA{
	...
	public TorontoClass()throws Exception{
		...
		Conferences.put("TORA100519", new Event("Conferences", "TORA100519", 20 ));
		Conferences.put("TORE100519", new Event("Conferences", "TORE100519", 20 ));
		Conferences.put("TORM100519", new Event("Conferences", "TORM100519", 20 ));
	
		Seminars.put("TORA100619", new Event("Seminars", "TORA100619", 20 ));
		Seminars.put("TORE100619", new Event("Seminars", "TORE100619", 20 ));
		Seminars.put("TORM100719", new Event("Seminars", "TORM100619", 20 ));
			
		TradeShows.put("TORA100719", new Event("TradeShows", "TORA100719", 20 ));
		TradeShows.put("TORE100719", new Event("TradeShows", "TORE100719", 20 ));
		TradeShows.put("TORM100719", new Event("TradeShows", "TORM100719", 20 ));
