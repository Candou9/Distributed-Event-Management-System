...
public class TorontoServer {
	...
	public static void main(String args[]) throws Exception
	{
		...
		try {
			...
			TorontoClass torobj = new TorontoClass();
			torobj.setORB(orb);

			// get object reference from the servant
			org.omg.CORBA.Object ref = rootpoa.servant_to_reference(torobj);
		...
		System.out.println("Toronto Server is Started");
	}

	private static void receive(TorontoClass obj) {
		...
		try {
			...
			System.out.println("Toronto UDP Server 8888 Started............");
			while (true) {
